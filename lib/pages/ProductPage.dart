...
class ProductPage extends StatelessWidget {
  ...
  // TODO: Сделать фетч товара с бека, если товар отсутствует в сторе
  ...
  Widget build(BuildContext context) {
    ...
    print(product.similarProductsInfo);
                    ...
                    SliverAppBar(
                      ...
                      actions: [
                        ...
                        ProductFavoriteButton(
                            productId: product.id, iconSize: 36),
                      ],
                            ...
                            CupertinoButton(
                                ...
                                onPressed: () {
                                  nav.pushNamed(FeedbacksPage.routeName,
                                      arguments:
                                          FeedbacksPageRouteArguments(product));
                                }),
                            Divider(color: Colors.grey[500]),
                          ...
                          builder: (context, inCart, child) => CupertinoButton(
                            ...
                            child: Text(
                                ...
                                style: AppTextTheme.xsTitle.merge(TextStyle(
                                    color:
                                        inCart ? Colors.white : Colors.black))),
                            onPressed: inCart
                                ? null
                                : () {
